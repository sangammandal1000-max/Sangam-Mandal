...
export const DeleteConfirmationModal: React.FC<DeleteConfirmationModalProps> = ({ isOpen, onClose, onConfirm, title, message, confirmText }) => {
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg w-full max-w-md m-4 transform transition-all animate-fade-in-up">
        ...
        <div className="p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="font-semibold text-gray-800 dark:text-gray-100">Are you sure?</p>
        ...
        <div className="flex justify-end gap-3 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-b-xl">
          ...
          <button onClick={onConfirm} className="px-4 py-2 text-sm font-semibold rounded-lg bg-red-600 text-white hover:bg-red-700">
            {confirmText}
          </button>
        </div>
      </div>
